;;; org-leuven-theme.el --- Awesome Emacs color theme on white background

;; Copyright (C) 2003-2021 Free Software Foundation, Inc.

;; Author: Fabrice Niessen <(concat "fniessen" at-sign "pirilampo.org")>
;; URL: https://github.com/fniessen/emacs-org-leuven-theme
...
;; This elegant Org-enhancing color theme "org-leuven" ROCKS!
;; ... and not just for Org mode.
;;
;; To use it, put the following in your Emacs configuration file:
;;
;;   (load-theme 'org-leuven t)
;;
...
(defgroup org-leuven nil
  "Org-Leuven theme options.
The theme has to be reloaded after changing anything in this group."
  :group 'faces)

(defcustom org-leuven-scale-org-document-title t
...
(defcustom org-leuven-scale-outline-headlines t
...
(defcustom org-leuven-scale-org-agenda-structure t
...
(defcustom org-leuven-scale-volatile-highlight t
...
;;;###autoload
(defun org-leuven-scale-font (control default-height)
...
(let ((class '((class color) (min-colors 89)))
      ...
      (volatile-highlight-supersize `(,@(org-leuven-scale-font org-leuven-scale-volatile-highlight 1.1) :underline nil :foreground "white" :background "#9E3699")) ; flash-region
  ...
  (custom-theme-set-faces
   ...
   `(org-leuven-org-deadline-overdue ((,class (:foreground "#F22659"))))
   `(org-leuven-org-deadline-today ((,class (:weight bold :foreground "#4F4A3D" :background "#FFFFCC"))))
   `(org-leuven-org-deadline-tomorrow ((,class (:foreground "#40A80B"))))
   `(org-leuven-org-deadline-future ((,class (:foreground "#40A80B"))))
   `(org-leuven-gnus-unseen ((,class (:weight bold :foreground "#FC7202"))))
   `(org-leuven-gnus-date ((,class (:foreground "#FF80BF"))))
   `(org-leuven-gnus-size ((,class (:foreground "#8FBF60"))))
   `(org-leuven-todo-items-face ((,class (:weight bold :foreground "#FF3125" :background "#FFFF88"))))
   ...
   `(org-agenda-date ((,class (,@(org-leuven-scale-font org-leuven-scale-org-agenda-structure 1.6) :weight bold :foreground "#1662AF"))))
   `(org-agenda-date-today ((,class (,@(org-leuven-scale-font org-leuven-scale-org-agenda-structure 1.6) :weight bold :foreground "#4F4A3D" :background "#FFFFCC"))))
   `(org-agenda-date-weekend ((,class (,@(org-leuven-scale-font org-leuven-scale-org-agenda-structure 1.6) :weight bold :foreground "#4E4E4E"))))
   ...
   `(org-agenda-structure ((,class (,@(org-leuven-scale-font org-leuven-scale-org-agenda-structure 1.6) :weight bold :foreground "#1F8DD6"))))
   ...
   `(org-document-info-keyword ((,class (:foreground "#E0E0E0"))))
   `(org-document-title ((,class (,@(org-leuven-scale-font org-leuven-scale-org-document-title 1.8)  :weight bold :foreground "black"))))
   `(org-done ((,class (:weight bold :box (:line-width 1 :color "#BBBBBB") :foreground "#BBBBBB" :background "#F0F0F0"))))
   `(org-drawer ((,class (:weight bold :foreground "#E0E0E0"))))
   ...
   `(org-property-value ((,class (:foreground "#E0E0E0"))))
   ...
   `(org-special-keyword ((,class (:weight bold :foreground "#E0E0E0"))))
...
(custom-theme-set-variables 'org-leuven
